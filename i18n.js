const TRANSLATIONS = {
  en: {
    ...
    inst_mac_s3: 'If macOS blocks the app — right-click → Open, or System Settings → Privacy & Security → Open Anyway',
    inst_mac_s4: 'Launch the app and scan your WhatsApp QR code',
    ...
    inst_linux_desc: 'AppImage — works on any modern Linux distribution without installation.',
    inst_linux_btn: 'Download .AppImage',
    inst_linux_s1: 'Download the .AppImage',
    inst_linux_s2: 'Make it executable:',
    inst_linux_s3: 'Run it:',
  ...
  fr: {
    ...
    inst_mac_s3: 'Si macOS bloque l\'app — clic droit → Ouvrir, ou Réglages → Confidentialité et sécurité → Ouvrir quand même',
    inst_mac_s4: 'Lancez l\'app et scannez votre QR WhatsApp',
    ...
    inst_linux_desc: 'AppImage — fonctionne sur toute distribution Linux moderne sans installation.',
    inst_linux_btn: 'Télécharger .AppImage',
    inst_linux_s1: 'Télécharger le .AppImage',
    inst_linux_s2: 'Rendre exécutable :',
    inst_linux_s3: 'Lancer :',
  ...
  es: {
    ...
    inst_mac_s3: 'Si macOS bloquea la app — clic derecho → Abrir, o Ajustes del Sistema → Privacidad y seguridad → Abrir de todos modos',
    inst_mac_s4: 'Lanza la app y escanea tu QR de WhatsApp',
    ...
    inst_linux_desc: 'AppImage — funciona en cualquier distribución Linux moderna sin instalación.',
    inst_linux_btn: 'Descargar .AppImage',
    inst_linux_s1: 'Descarga el .AppImage',
    inst_linux_s2: 'Hazlo ejecutable:',
    inst_linux_s3: 'Ejecútalo:',
  ...
  pt: {
    ...
    inst_mac_s3: 'Se macOS bloquear o app — clique direito → Abrir, ou Configurações → Privacidade e segurança → Abrir assim mesmo',
    inst_mac_s4: 'Abra o app e escaneie o QR do WhatsApp',
    ...
    inst_linux_desc: 'AppImage — funciona em qualquer distribuição Linux moderna sem instalação.',
    inst_linux_btn: 'Baixar .AppImage',
    inst_linux_s1: 'Baixe o .AppImage',
    inst_linux_s2: 'Torne-o executável:',
    inst_linux_s3: 'Execute-o:',
  ...
  tr: {
    ...
    inst_mac_s3: 'macOS uygulamayı engellerse — sağ tık → Aç, ya da Sistem Ayarları → Gizlilik ve Güvenlik → Yine de Aç',
    inst_mac_s4: 'Uygulamayı başlatın ve WhatsApp QR\'ınızı tarayın',
    ...
    inst_linux_desc: 'AppImage — kurulum gerektirmeden herhangi bir modern Linux dağıtımında çalışır.',
    inst_linux_btn: '.AppImage İndir',
    inst_linux_s1: '.AppImage\'ı indirin',
    inst_linux_s2: 'Çalıştırılabilir yapın:',
    inst_linux_s3: 'Çalıştırın:',
