const TRANSLATIONS = {
  en: {
    ...
    ss_cap_1: 'Main dashboard with session overview',
    ss_cap_2: 'Visual flow builder for automation',
    ss_cap_3: 'Broadcast campaign manager',
    ss_cap_4: 'Unified chat inbox across all sessions',
  ...
  fr: {
    ...
    ss_cap_4: 'Boîte de réception unifiée sur toutes les sessions',
  ...
  es: {
    ...
    ss_cap_4: 'Bandeja de entrada unificada para todas las sesiones',
  ...
  pt: {
    ...
    ss_cap_4: 'Caixa de entrada unificada em todas as sessões',
  ...
  tr: {
    ...
    ss_cap_4: 'Tüm oturumlarda birleşik sohbet gelen kutusu',
